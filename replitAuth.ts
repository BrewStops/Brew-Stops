...
export async function setupAuth(app: Express) {
  ...
  app.get("/api/login", (req, res, next) => {
    console.log("[AUTH] Login initiated from:", req.headers.referer || 'direct');
        ...
        return res.status(500).send(`
          <html>
            <body style="font-family: sans-serif; padding: 20px; text-align: center;">
              ...
              <a href="/" style="display: inline-block; margin-top: 20px; padding: 10px 20px; background: #4CAF50; color: white; text-decoration: none; border-radius: 4px;">Return to App</a>
            </body>
          </html>
        `);
      }
